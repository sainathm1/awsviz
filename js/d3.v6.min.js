...
!(function (t, n) {
    ...
    function xt(t) {
        var n = (t += ""),
            e = n.indexOf(":");
        return e >= 0 && "xmlns" !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), mt.hasOwnProperty(n) ? { space: mt[n], local: t } : t;
    }
    function wt(t) {
        return function () {
            ...
            (n = re.exec(t))
                ? ((e = n[1].length),
                  ...
                  6 === e
                      ...
                      : 4 === e
                      ? ge(((n >> 12) & 15) | ((n >> 8) & 240), ((n >> 8) & 15) | ((n >> 4) & 240), ((n >> 4) & 15) | (240 & n), (((15 & n) << 4) | (15 & n)) / 255)
                      : null)
                : (n = ie.exec(t))
    ...
    function Me(t) {
        ...
        var n = (t = t.rgb()).r / 255,
            ...
            u = o - i,
            c = (o + i) / 2;
        return u ? ((a = n === o ? (e - r) / u + 6 * (e < r) : e === o ? (r - n) / u + 2 : (n - e) / u + 4), (u /= c < 0.5 ? o + i : 2 - o - i), (a *= 60)) : (u = c > 0 && c < 1 ? 0 : a), new Te(a, u, c, t.opacity);
    }
    function Ae(t, n, e, r) {
    ...
    function qe(t) {
        ...
        return (
            r === i && i === o ? (n = e = a) : ((n = Oe((0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / Ne)), (e = Oe((0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / Ce))), new Fe(116 * a - 16, 500 * (n - a), 200 * (a - e), t.opacity)
        );
    }
    function Re(t, n, e, r) {
    ...
    function wr(t, n) {
        ...
        for (t += "", n += ""; (e = mr.exec(t)) && (r = xr.exec(n)); )
            (i = r.index) > o && ((i = n.slice(o, i)), u[a] ? (u[a] += i) : (u[++a] = i)), (e = e[0]) === (r = r[0]) ? (u[a] ? (u[a] += r) : (u[++a] = r)) : ((u[++a] = null), c.push({ i: a, x: _r(e, r) })), (o = xr.lastIndex);
        return (
    ...
    function Nr(t, n, e, r) {
        ...
        return function (o, a) {
            ...
            return (
                ...
                (function (t, n, e, o) {
                    t !== n ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360), o.push({ i: e.push(i(e) + "rotate(", null, r) - 2, x: _r(t, n) })) : n && e.push(i(e) + "rotate(" + n + r);
                })(o.rotate, a.rotate, u, c),
                (function (t, n, e, o) {
                    t !== n ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: _r(t, n) }) : n && e.push(i(e) + "skewX(" + n + r);
                })(o.skewX, a.skewX, u, c),
    ...
    var Cr = Nr(
        ...
        Pr = Nr(
            function (t) {
                return null == t
                    ? Er
                    : (Tr || (Tr = document.createElementNS("http://www.w3.org/2000/svg", "g")), Tr.setAttribute("transform", t), (t = Tr.transform.baseVal.consolidate()) ? kr((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : Er);
            },
            ", ",
            ")",
            ")"
    ...
    function li(t, n, e, r, i, o) {
                ...
                for (f in i)
                    if ((h = i[f]).name === e.name) {
                        ...
                        4 === h.state
                            ...
                            : +f < n && ((h.state = 6), h.timer.stop(), h.on.call("cancel", t, t.__data__, h.index, h.group), delete i[f]);
                    }
                if (
                    (ci(function () {
        ...
        })(t, e, { name: n, index: r, group: i, on: fi, tween: si, time: o.time, delay: o.delay, duration: o.duration, ease: o.ease, timer: null, state: 0 });
    }
    function hi(t, n) {
        var e = pi(t, n);
    ...
    var io = 4 / 11,
        oo = 7.5625;
    function ao(t) {
        return (t = +t) < io ? oo * t * t : t < 0.7272727272727273 ? oo * (t -= 0.5454545454545454) * t + 0.75 : t < 0.9090909090909091 ? oo * (t -= 0.8181818181818182) * t + 0.9375 : oo * (t -= 0.9545454545454546) * t + 0.984375;
    }
    var uo = 1.70158,
        co = (function t(n) {
            function e(t) {
        ...
        function h(e) {
            ...
            function U(t) {
                ...
                switch (((C = n[0] - e[0]), (P = n[1] - e[1]), m)) {
                    ...
                    case To:
                        D[1]
                            ? (x && ((a = ko(S, No(k, D[0][0]))), (h = ko(S, No(k, D[1][0]))), (x = 1)), w && ((c = ko(E, No(N, D[0][1]))), (p = ko(E, No(N, D[1][1]))), (w = 1)))
                            : (x < 0 ? ((C = ko(S - i, No(k - i, C))), (a = i + C), (h = l)) : x > 0 && ((C = ko(S - l, No(k - l, C))), (a = i), (h = l + C)),
                              w < 0 ? ((P = ko(E - u, No(N - u, P))), (c = u + P), (p = d)) : w > 0 && ((P = ko(E - d, No(N - d, P))), (c = u), (p = d + P)));
                        break;
                    case So:
                        x && ((a = ko(S, No(k, i - C * x))), (h = ko(S, No(k, l + C * x)))), w && ((c = ko(E, No(N, u - P * w))), (p = ko(E, No(N, d + P * w))));
                }
                h < a && ((x *= -1), (r = i), (i = l), (l = r), (r = a), (a = h), (h = r), b in Fo && R.attr("cursor", Ro[(b = Fo[b])])),
                    p < c && ((w *= -1), (r = u), (u = d), (d = r), (r = c), (c = p), (p = r), b in Oo && R.attr("cursor", Ro[(b = Oo[b])])),
            ...
            function L(t) {
                switch (t.keyCode) {
                    ...
                    case 32:
                        m === Ao &&
                            (t.altKey ? (x && ((l = h - C * x), (i = a + C * x)), w && ((d = p - P * w), (u = c + P * w)), (m = So)) : (x < 0 ? (l = h) : x > 0 && (i = a), w < 0 ? (d = p) : w > 0 && (u = c), (m = To)),
                            R.attr("cursor", Ro[b]),
                            U());
                        break;
                    default:
        ...
        return (
            ...
            (l.prototype = {
                ...
                emit: function (n, e, r) {
                    ...
                    a.call(n, this.that, new mo(n, { sourceEvent: e, target: c, selection: t.output(this.state.selection), mode: r, dispatch: a }), i);
                },
            }),
            (c.extent = function (t) {
                ...
                for (const e of s) {
                    ...
                    if (t) {
                        ...
                        for (const r of t) {
                            ...
                            if (
                                (e < r
                                    ? ((t = l[e * c + r] || (l[e * c + r] = { source: null, target: null })), (t.source = { index: e, startAngle: n, endAngle: (n += a[e * c + r] * d), value: a[e * c + r] }))
            ...
            null === this._x1 ? (this._ += "M" + c + "," + f) : (Math.abs(this._x1 - c) > aa || Math.abs(this._y1 - f) > aa) && (this._ += "L" + c + "," + f),
                e &&
                    ...
                    l > ua
                        ...
                        : l > aa && (this._ += "A" + e + "," + e + ",0," + +(l >= ia) + "," + s + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))));
        },
    ...
    function ba(t) {
        ...
        function f() {
            ...
            if (
                (c || (c = f = fa()),
                h > ta && (Vo(y - g) > 2 * h + ta ? (y > g ? ((g += h), (y -= h)) : ((g -= h), (y += h))) : (g = y = (g + y) / 2), Vo(b - _) > 2 * h + ta ? (b > _ ? ((_ += h), (b -= h)) : ((_ -= h), (b += h))) : (_ = b = (_ + b) / 2)),
    ...
    function uu(t) {
        ...
        return isNaN(t)
            ...
            : (function (t) {
                  ...
                  "-" +
                  au(t.getUTCDate(), 2) +
                  (i ? "T" + au(n, 2) + ":" + au(e, 2) + ":" + au(r, 2) + "." + au(i, 3) + "Z" : r ? "T" + au(n, 2) + ":" + au(e, 2) + ":" + au(r, 2) + "Z" : e || n ? "T" + au(n, 2) + ":" + au(e, 2) + "Z" : "");
    }
    function cu(t) {
        var n = new RegExp('["' + t + "\n\r]"),
            e = t.charCodeAt(0);
    ...
    (Xu.copy = function () {
        ...
        for (t = [{ source: r, target: (e._root = new Array(4)) }]; (r = t.pop()); ) for (var i = 0; i < 4; ++i) (n = r.source[i]) && (n.length ? t.push({ source: n, target: (r.target[i] = new Array(4)) }) : (r.target[i] = Hu(n)));
        return e;
    }),
        (Xu.add = function (t) {
    ...
    function ac(t) {
        ...
        var n;
        return new uc({ fill: n[1], align: n[2], sign: n[3], symbol: n[4], zero: n[5], width: n[6], comma: n[7], precision: n[8] && n[8].slice(1), trim: n[9], type: n[10] });
    }
    function uc(t) {
    ...
    function Xf(t, n) {
        ...
        if (ff) {
            ...
            var o,
                ...
                c = i[0] * Tc * u,
                f = Ec(a) > 180;
            f ^ (u * af < c && c < u * t) ? (o = i[1] * Tc) > of && (of = o) : f ^ (u * af < (c = ((c + 360) % 360) - 180) && c < u * t) ? (o = -i[1] * Tc) < ef && (ef = o) : (n < ef && (ef = n), n > of && (of = n)),
                f ? (t < af ? Kf(nf, t) > Kf(nf, rf) && (rf = t) : Kf(t, rf) > Kf(nf, rf) && (nf = t)) : rf >= nf ? (t < nf && (nf = t), t > rf && (rf = t)) : t > af ? Kf(nf, t) > Kf(nf, rf) && (rf = t) : Kf(t, rf) > Kf(nf, rf) && (nf = t);
            ...
            function (t) {
                ...
                return {
                    ...
                    point: function (l, h) {
                        ...
                        if ((!n && (f = c = g) && t.lineStart(), g !== c && (!(d = a(n, p)) || ws(n, d) || ws(p, d)) && (p[2] = 1), g !== c))
                            (s = 0), g ? (t.lineStart(), (d = a(p, n)), t.point(d[0], d[1])) : ((d = a(n, p)), t.point(d[0], d[1], 2), t.lineEnd()), (n = d);
                        else if (i && n && r ^ g) {
                            var v;
                            y & e ||
                                !(v = a(p, n, !0)) ||
                                ((s = 0), r ? (t.lineStart(), t.point(v[0][0], v[0][1]), t.point(v[1][0], v[1][1]), t.lineEnd()) : (t.point(v[1][0], v[1][1]), t.lineEnd(), t.lineStart(), t.point(v[0][0], v[0][1], 3)));
                        }
                  ...
                  function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
                      ...
                      if (b > 4 * n && g--) {
                          var m = a + h,
                              ...
                              C = k - i,
                              P = _ * N - v * C;
                          ((P * P) / b > n || Ec((v * N + _ * C) / b - 0.5) > 0.3 || a * h + u * d + c * p < sh) && (e(r, i, o, a, u, c, E, k, T, (m /= M), (x /= M), w, g, y), y.point(E, k), e(E, k, T, m, x, w, f, s, l, h, d, p, g, y));
                      }
                  }
                  return function (n) {
                      var r,
    ...
    function gh(t) {
        ...
        return (
            ...
            (E.clipExtent = function (t) {
                return arguments.length
                    ? ((T = null == t ? ((A = r = i = o = null), fl) : Us((A = +t[0][0]), (r = +t[0][1]), (i = +t[1][0]), (o = +t[1][1]))), C())
                    : null == A
                    ? null
                    : [
                          [A, r],
    ...
    function Xh(t, n) {
        ...
        for (var e, r, i, o, a, u = new Zh(t), c = [u]; (e = c.pop()); )
            if ((i = n(e.data)) && (a = (i = Array.from(i)).length)) for (e.children = i, o = a - 1; o >= 0; --o) c.push((r = i[o] = new Zh(i[o]))), (r.parent = e), (r.depth = e.depth + 1);
    ...
    function zd(t, n, e, r, i, o) {
        for (var a, u, c, f, s, l, h, d, p, g, y, v = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x; ) {
            ...
            v.push((a = { value: s, dice: c < f, children: _.slice(b, m) })), a.dice ? bd(a, e, r, i, w ? (r += (f * s) / w) : o) : Cd(a, e, r, w ? (e += (c * s) / w) : i, o), (w -= s), (b = m);
        }
        return v;
    }
    var Dd = (function t(n) {
        ...
        function w(t, n) {
            return function (e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++u < f; )
                    37 === t.charCodeAt(u) && (a.push(t.slice(c, u)), null != (i = iy[(r = t.charAt(++u))]) ? (r = t.charAt(++u)) : (i = "e" === r ? " " : "0"), (o = n[r]) && (r = o(e, i)), a.push(r), (c = u + 1));
                ...
                if ((n && !("Z" in o) && (o.Z = 0), "p" in o && (o.H = (o.H % 12) + 12 * o.p), void 0 === o.m && (o.m = "q" in o ? o.q : 0), "V" in o)) {
                    ...
                    "w" in o || (o.w = 1),
                        "Z" in o
                            ...
                            : ((i = (r = Jg(ny(o.y, 0, 1))).getDay()), (r = i > 4 || 0 === i ? ag.ceil(r) : ag(r)), (r = eg.offset(r, 7 * (o.V - 1))), (o.y = r.getFullYear()), (o.m = r.getMonth()), (o.d = r.getDate() + ((o.w + 6) % 7)));
        ...
        (Ym.prototype = {
            ...
            lineEnd: function () {
                ...
                if (e)
                    ...
                    else for (var r = Lm(t), i = Lm(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
    ...
    (ex.prototype = tx.prototype),
        ...
        (t.drag = function () {
            ...
            function b(t, n, e, r, i, o) {
                var u,
                    ...
                    p = f.copy(),
                    g = In(o || e, n);
                if (null != (d = a.call(t, new Hn("beforestart", { sourceEvent: e, target: h, identifier: i, active: s, x: g[0], y: g[1], dx: 0, dy: 0, dispatch: p }), r)))
                    return (
                        (u = d.x - g[0] || 0),
                        (l = d.y - g[1] || 0),
                        function e(o, a, f) {
                            ...
                            p.call(o, t, new Hn(o, { sourceEvent: a, subject: d, target: h, identifier: i, active: y, x: g[0] + u, y: g[1] + l, dx: g[0] - v[0], dy: g[1] - v[1], dispatch: p }), r);
                        }
                    );
            }
            return (
        ...
        (t.geoCircle = function () {
            ...
            function a() {
                ...
                return (t = []), (n = ps(-a[0] * Sc, -a[1] * Sc, 0).invert), bs(o, u, c, 1), (a = { type: "Polygon", coordinates: [t] }), (t = n = null), a;
            }
            return (
                (a.center = function (t) {
        ...
        (t.geoIdentity = function () {
            ...
            return (
                ...
                (b.clipExtent = function (t) {
                    return arguments.length
                        ? ((v = null == t ? ((d = e = r = i = null), fl) : Us((d = +t[0][0]), (e = +t[0][1]), (r = +t[1][0]), (i = +t[1][1]))), _())
                        : null == d
                        ? null
                        : [
                              [d, e],
        ...
        (t.interpolateSinebow = function (t) {
            var n;
            return (t = (0.5 - t) * Math.PI), (W_.r = 255 * (n = Math.sin(t)) * n), (W_.g = 255 * (n = Math.sin(t + Z_)) * n), (W_.b = 255 * (n = Math.sin(t + K_)) * n), W_ + "";
        }),
            ...
            function i(i) {
                var c = (function (t) {
                    for (var n, e, r, i, o, a = new Nd(t, 0), u = [a]; (n = u.pop()); )
                        if ((r = n._.children)) for (n.children = new Array((o = r.length)), i = o - 1; i >= 0; --i) u.push((e = n.children[i] = new Nd(r[i], i))), (e.parent = n);
        ...
        (t.zoom = function () {
            ...
            function S(e, ...i) {
                if (r.apply(this, arguments)) {
                    ...
                    for (rx(e), a = 0; a < s; ++a)
                        (c = [(c = In((u = f[a]), this)), this.__zoom.invert(c), u.identifier]), l.touch0 ? l.touch1 || l.touch0[2] === c[2] || ((l.touch1 = c), (l.taps = 0)) : ((l.touch0 = c), (o = !0), (l.taps = 1 + !!t));
                    t && (t = clearTimeout(t)),
                        o &&
                            (l.taps < 2 &&
                                ((n = c[0]),
            ...
            return (
                ...
                (w.prototype = {
                    ...
                    emit: function (t) {
                        ...
                        h.call(t, this.that, new Jm(t, { sourceEvent: this.sourceEvent, target: y, type: t, transform: this.that.__zoom, dispatch: h }), n);
                    },
                }),
